/* ============================================================
   ...
   navegador. Los AJUSTES generales (temporizador, progreso) viven en el
   editor (src/modos/editor.js).
   IMPORTANTE: las claves de localStorage (claveBancoCustom / claveOcultasOrto)
   deben coincidir con las que lee el generador en src/modos/ortografia.js.
   ============================================================ */
