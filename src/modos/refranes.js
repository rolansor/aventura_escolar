...
(function () {
  ...
  const REFRANES = [
    [ // básico
      ...
      { a: "Más vale prevenir…", b: "…que lamentar" },
      { a: "El que la sigue…", b: "…la consigue" },
      { a: "Querer es…", b: "…poder" },
      { a: "A mal tiempo…", b: "…buena cara" },
      { a: "Más vale solo…", b: "…que mal acompañado" }
    ],
    [ // intermedio
      ...
      { a: "No hay mal…", b: "…que por bien no venga" },
      { a: "Cada oveja…", b: "…con su pareja" },
      { a: "Quien mucho duerme…", b: "…poco aprende" },
      { a: "Al mal paso…", b: "…darle prisa" },
      { a: "Agua que no has de beber…", b: "…déjala correr" }
    ],
    [ // avanzado
      ...
      { a: "El que no arriesga…", b: "…no gana" },
      { a: "No hay peor ciego…", b: "…que el que no quiere ver" },
      { a: "Aunque la mona se vista de seda…", b: "…mona se queda" },
      { a: "Más vale maña…", b: "…que fuerza" },
      { a: "Donde manda capitán…", b: "…no manda marinero" }
    ]
  ];
  ...
  const ADIVINANZAS = [
    [ // básico
      ...
      { a: "Tiene dientes y no muerde…", b: "el peine" },
      { a: "Pequeña como un ratón y cuida la casa como un león…", b: "la llave" },
      { a: "Blanco por dentro, la gallina lo pone…", b: "el huevo" },
      { a: "Cae de una torre y no se mata; cae al agua y se deshace…", b: "el papel" },
      { a: "Vuelo de noche, duermo de día y nunca verás plumas en el ala mía…", b: "el murciélago" }
    ],
    [ // intermedio
      ...
      { a: "Una señorita muy aseñorada, siempre va en coche y siempre mojada…", b: "la lengua" },
      { a: "Todos me pisan a mí, pero yo no piso a nadie…", b: "el camino" },
      { a: "Blanca soy, blanca nací; pobres y ricos comen de mí…", b: "la sal" },
      { a: "Cien damas en un camino y no hacen polvo ni remolino…", b: "las hormigas" },
      { a: "Largo larguero, ni ojos ni narices y muchos agujeritos…", b: "la flauta" }
    ],
    [ // avanzado
      ...
      { a: "En alto vive, en alto mora; en alto teje la tejedora…", b: "la araña" },
      { a: "Verde por fuera, roja por dentro y con pepitas en el centro…", b: "la sandía" },
      { a: "Cuanto más lavo, más sucia voy…", b: "el agua" },
      { a: "Una vieja con un solo diente que llama a toda la gente…", b: "la campana" },
      { a: "Del cielo bajo al campo y lo hago florecer…", b: "la lluvia" }
    ]
  ];
